...
// NOTE: clip.h intentionally does NOT include ggml.h — none of its declarations
// use ggml types (clip_ctx is opaque), so consumers don't need ggml headers.
// clip.cpp includes ggml directly.
#include <stdint.h>
#include <stddef.h>
